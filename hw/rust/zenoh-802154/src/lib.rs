...
unsafe extern "C" fn zenoh_802154_read(opaque: *mut c_void, offset: u64, _size: c_uint) -> u64 {
    ...
    zenoh_802154_read_internal(&*s.rust_state, offset)
}
...
fn zenoh_802154_init_internal(
    ...
    Box::into_raw(Box::new(Zenoh802154State {
        session,
        irq,
        node_id,
        topic,
...
fn zenoh_802154_read_internal(_state: &Zenoh802154State, _offset: u64) -> u64 {
    // Implement actual read logic here if needed
    0
}

fn zenoh_802154_write_internal(_state: &mut Zenoh802154State, _offset: u64, _value: u64) {
    // Implement actual write logic here if needed
}

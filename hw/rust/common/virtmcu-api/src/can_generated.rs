    ...
    pub mod can {
        ...
        impl<'a> CanFdFrame<'a> {
            ...
            pub fn delivery_vtime_ns(&self) -> u64 {
                unsafe {
                    self._tab
                        .get::<u64>(CanFdFrame::VT_DELIVERY_VTIME_NS, Some(0))
            ...
            pub fn sequence_number(&self) -> u64 {
                unsafe {
                    self._tab
                        .get::<u64>(CanFdFrame::VT_SEQUENCE_NUMBER, Some(0))
                        .expect("FlatBuffers generated code assumption")
                }
            }
            #[inline]
            pub fn can_id(&self) -> u32 {
                unsafe {
                    self._tab
                        .get::<u32>(CanFdFrame::VT_CAN_ID, Some(0))
                        .expect("FlatBuffers generated code assumption")
                }
            }
            #[inline]
            pub fn flags(&self) -> u32 {
                unsafe {
                    self._tab
                        .get::<u32>(CanFdFrame::VT_FLAGS, Some(0))
                        .expect("FlatBuffers generated code assumption")
                }
            }
            #[inline]

...
pub mod virtmcu {
    ...
    pub mod core {
        ...
        impl ::flatbuffers::EndianScalar for Protocol {
            ...
            #[inline]
            #[allow(clippy::wrong_self_convention)] // virtmcu-allow: allow reasoning="FlatBuffers-generated code"
        ...
        impl<'a> VirtmcuHandshake {
            #[allow(clippy::too_many_arguments)] // virtmcu-allow: allow reasoning="FlatBuffers-generated code"
        ...
        impl<'a> CoordMessage<'a> {
            ...
            pub fn src_node_id(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(CoordMessage::VT_SRC_NODE_ID, Some(0))
                        .expect("FlatBuffers generated code assumption")
                }
            }
            #[inline]
            pub fn dst_node_id(&self) -> u32 {
                ...
                unsafe {
                    self._tab
                        .get::<u32>(CoordMessage::VT_DST_NODE_ID, Some(0))
                        .expect("FlatBuffers generated code assumption")
                }
            }
            #[inline]
            pub fn delivery_vtime_ns(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(CoordMessage::VT_DELIVERY_VTIME_NS, Some(0))
                        .expect("FlatBuffers generated code assumption")
                }
            }
            #[inline]
            pub fn sequence_number(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(CoordMessage::VT_SEQUENCE_NUMBER, Some(0))
                        .expect("FlatBuffers generated code assumption")
                }
            }
            #[inline]
        ...
        impl<'a> CoordDoneReq<'a> {
            ...
            pub fn quantum(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(CoordDoneReq::VT_QUANTUM, Some(0))
                        .expect("FlatBuffers generated code assumption")
                }
            }
            #[inline]
            pub fn vtime_limit(&self) -> u64 {
                ...
                unsafe {
                    self._tab
                        .get::<u64>(CoordDoneReq::VT_VTIME_LIMIT, Some(0))
                        .expect("FlatBuffers generated code assumption")
                }
            }
            #[inline]

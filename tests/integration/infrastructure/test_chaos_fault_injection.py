...
async def test_multi_node_chaos(simulation: Simulation) -> None:
    """
    ...
    inner = ZenohTransportImpl(simulation._router, simulation._session)
    ...
    def _nodes_alive(s: Simulation) -> bool:
        return "HI" in s.uart_buffer(0) and "HI" in s.uart_buffer(1)

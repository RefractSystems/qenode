...
@pytest.mark.asyncio
async def test_shutdown_while_blocked(simulation: Simulation, guest_app_factory: Any) -> None:
    """
...
@pytest.mark.asyncio
async def test_shutdown_during_vta_step(simulation: Simulation, guest_app_factory: Any) -> None:
    """

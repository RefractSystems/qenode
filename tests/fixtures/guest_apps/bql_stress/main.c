 ...
 * If the emulator doesn't yield the BQL, the main loop will starve and the test will timeout.
 */
...
int main() {
    uart_puts("BQL stress test starting...\n");
    uart_puts("Entering tight polling loop...\n");
    ...
    uart_puts("Starvation avoided! Data received.\n");

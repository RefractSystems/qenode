#!/usr/bin/env bash
# tests/fixtures/guest_apps/phase18/bql_deadlock_test.sh — Phase 18 deadlock test for clock
set -euo pipefail
...
python3 "$WORKSPACE_DIR/tests/fixtures/guest_apps/phase18/bql_deadlock_test.py" "$QMP_SOCK" "tcp/127.0.0.1:$PORT"

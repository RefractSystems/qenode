...
TMPDIR_LOCAL="$(mktemp -d /tmp/phase8_uart_XXXXXX)"
QEMU_PID=""
ROUTER_PID=""
...
python3 "$WORKSPACE_DIR/tests/fixtures/guest_apps/phase8/uart_flood_test.py" "$ENDPOINT"
...
echo "=== Phase 8 UART Flood Test PASSED (No Crash) ==="

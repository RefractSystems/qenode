#!/usr/bin/env bash
# tests/fixtures/guest_apps/phase12/telemetry_throughput_test.sh — Phase 12.8 Telemetry Throughput Benchmark
#
...
# Run explicitly with:
#   bash tests/fixtures/guest_apps/phase12/telemetry_throughput_test.sh
set -euo pipefail

...
async def main():
    ...
    yaml_path = Path(WORKSPACE_DIR) / "tests" / "fixtures" / "guest_apps" / "phase3" / "test_board.yaml"
    with Path(yaml_path).open() as f:
        board_config = f.read()
    firmware_path = Path(WORKSPACE_DIR) / "tests" / "fixtures" / "guest_apps" / "phase1" / "hello.elf"

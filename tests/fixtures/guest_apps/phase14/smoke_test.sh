#!/bin/bash
# tests/fixtures/guest_apps/phase14/smoke_test.sh
...
python3 -m tools.yaml2qemu tests/fixtures/guest_apps/phase14/board.yaml --out-dtb tests/fixtures/guest_apps/phase14/test.dtb --out-cli tests/fixtures/guest_apps/phase14/test.cli
...
HCI_CLI=$(grep "^virtmcu" tests/fixtures/guest_apps/phase14/test.cli || true)
...
echo "Verifying DTB..."
DTS_CONTENT=$(dtc -I dtb -O dts tests/fixtures/guest_apps/phase14/test.dtb)

...
def test_get_rust_binary_path_cargo_target_dir(monkeypatch, tmp_path):
...
def test_get_rust_binary_path_workspace_fallback(mock_exists, monkeypatch):
...
def test_resolve_rust_binary_missing():

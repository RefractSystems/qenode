...
IMAGE_TAG ?= dev
VIRTMCU_DEVENV_IMG ?= $(VIRTMCU_IMAGE_REGISTRY)/devenv:$(IMAGE_TAG)-$(ARCH)
VIRTMCU_CI_IMG ?= $(VIRTMCU_IMAGE_REGISTRY)/ci:$(IMAGE_TAG)-$(ARCH)
VIRTMCU_CI_ASAN_IMG ?= $(VIRTMCU_IMAGE_REGISTRY)/ci:$(IMAGE_TAG)-asan-$(ARCH)

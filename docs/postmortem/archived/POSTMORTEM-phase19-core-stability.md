...
Actuator integration tests (`tests/fixtures/guest_apps/actuator/`) failed with "Incomplete payload" errors. The test script expected 12 bytes but received only 4.

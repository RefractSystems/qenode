...
2. **Language Agnostic**: The `Physical Node` can be written in Python, the `virtmcu-coord` in Rust, and the QEMU plugins in Rust. They all interoperate seamlessly.

#!/usr/bin/env python3
"""
analyze_coverage.py - Maps drcov coverage traces to ELF symbols.

This tool parses .drcov files (generated by tools like DynamoRIO or QEMU plugins)
and correlates the executed basic blocks with symbols in a guest ELF binary.
